...
add wave -noupdate /tb_FFT_datapath/X_0_re
add wave -noupdate /tb_FFT_datapath/X_1_re
add wave -noupdate /tb_FFT_datapath/X_4_re
add wave -noupdate /tb_FFT_datapath/X_5_re
add wave -noupdate /tb_FFT_datapath/X_0_im
add wave -noupdate /tb_FFT_datapath/X_1_im
add wave -noupdate /tb_FFT_datapath/X_4_im
add wave -noupdate /tb_FFT_datapath/X_5_im
add wave -noupdate /tb_FFT_datapath/X_2_re
add wave -noupdate /tb_FFT_datapath/X_3_re
add wave -noupdate /tb_FFT_datapath/X_6_re
add wave -noupdate /tb_FFT_datapath/X_7_re
add wave -noupdate /tb_FFT_datapath/X_2_im
add wave -noupdate /tb_FFT_datapath/X_3_im
add wave -noupdate /tb_FFT_datapath/X_6_im
add wave -noupdate /tb_FFT_datapath/X_7_im
